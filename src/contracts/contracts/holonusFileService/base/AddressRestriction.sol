...
contract AddressRestriction is Owned {

    mapping(address => bool) internal allowAccount;
    ...
    modifier isAllow() {
        require(allowAccount[msg.sender]);
        _;
    }

    function enableAllowAccount(address account, bool enable) public onlyOwner {
        allowAccount[account] = enable;
    }

    function isEnableAllowAccount(address account) public view returns(bool) {
