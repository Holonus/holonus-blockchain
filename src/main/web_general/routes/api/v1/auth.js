...
const authProcess = require('../../../process/api/v1/auth');
const v1Process = require('../../../process/api/v1');

router.post('/auth/login', authProcess.postLoginValid, authProcess.postLogin);
router.delete('/auth/login', v1Process.useAuthorization, authProcess.deleteLoginValid, authProcess.deleteLogin);
